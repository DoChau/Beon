...
export default async function About() {
    ...
    <div className="w-full bg-theme-10 grid gap-4 xsmall:gap-6 font-futura text-theme-4 font-thin text-sm">
      ...
      <div className="w-full max-w-6xl min-h-screen mx-auto grid place-content-start gap-4 xsmall:gap-6">
        <h1 className="Services-title font-normal text-xl md:text-3xl uppercase mx-auto drop-shadow-xl">OUR COLLECTION</h1>
            ...
            <div className="mb-4 flex items-center justify-center font-normal text-base">
              <ul className="flex flex-wrap" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                  <li className="mr-2" role="presentation">
                      <button className="uppercase inline-block hover:text-theme-3 hover:bg-theme-7 focus:bg-theme-14 active:bg-theme-14 rounded-full py-2 px-2 text-center active" id="description-tab" data-tabs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true">Description</button>
                  </li>
                  <li className="mr-2" role="presentation">
                      <button className="uppercase inline-block hover:text-theme-3 hover:bg-theme-7 focus:bg-theme-14 active:bg-theme-14 rounded-full py-2 px-2 text-center" id="location-tab" data-tabs-target="#location" type="button" role="tab" aria-controls="location" aria-selected="false">Location</button>
                  </li>
                  <li className="mr-2" role="presentation">
                      <button className="uppercase inline-block hover:text-theme-3 hover:bg-theme-7 focus:bg-theme-14 active:bg-theme-14 rounded-full py-2 px-2 text-center" id="experiences-tab" data-tabs-target="#experiences" type="button" role="tab" aria-controls="experiences" aria-selected="false">Experience</button>
                  </li>
              </ul>
            </div>

            <div className="w-full justify-center" id="myTabContent">
                <div className="w-full xsmall:inline-flex items-start xsmall:space-x-10" id="description" role="tabpanel" aria-labelledby="description-tab">
                ...
                <div className=" hidden" id="location" role="tabpanel" aria-labelledby="location-tab">
                  <div>
                    <iframe 
                ...
                <div className="w-full xsmall:inline-flex hidden items-start justify-center xsmall:space-x-10" id="experiences" role="tabpanel" aria-labelledby="experiences-tab">
