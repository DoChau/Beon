...
export default async function Policy() {
    return (
    <>
    <div className="w-full bg-gray-300 text-base-content grid gap-4 pb-6 xsmall:gap-6 font-futura text-xs">
      ...
      <div className="w-full max-w-6xl min-h-screen mx-auto grid place-content-start gap-4 md:gap-6">
        ...
        <h1 className="Services-title font-normal text-xl text-base-content md:text-2xl uppercase mx-auto drop-shadow-xl">Policy</h1>
        ...
        <div className="w-full grid gap-6 xsmall:grid-cols-3 xsmall:gap-8 text-base px-6">
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Credit card policy</h2>
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Jewelry, Phone & personal belongings</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Pricing</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Sanitation</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Appoinments</h2>
            <h3 className="text-xs text-justify">
              Your safety and your satisfaction is our top priority. We use hospital grade autoclave machine, which is used to sterilize all of our tools along with storing our tools in sanitary pouches to avoid contamination of any kind. Our spas are equipped with innovative removable jets which are always soaked in Barbicide to make sure it’s bacteria free. We use disposable file, buffer, and pumice sponges for each client. We also use a disposable tub liner for better sanitation.
            </h3>
          </div>
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Cancelation</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Refund</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Complimentary services</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Medical conditions</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Tardiness</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Gift certificates</h2>
            <h3 className="text-xs text-justify">
          ...
          <div className="w-full items-start justify-center space-y-4">
            <h2 className="font-bold text-center text-primary">Spa party</h2>
            <h3 className="text-xs text-justify">
        ...
        <h1 className="Services-title font-futura font-normal text-primary underline mx-auto">
          Beon Nails staff
        </h1>
